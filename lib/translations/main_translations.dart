...
class MainTranslations {
  ...
  static const Map<String, Map<String, String>> translations = {
    ...
    "business_registration_number": {
      ...
      "MY": "Business Registration Number"
    },
    "ecommerce_registration_number": {
      ...
      "MY": "E-commerce Registration Number"
    },
    "tourism_business_license": {
      ...
      "MY": "Tourism Business License No."
    },
    "comprehensive_travel_business": {
      ...
      "MY": "Comprehensive Travel Business"
    },
    "tel": {
      "KR": "전화",
      "VN": "Điện thoại",
    ...
    "achasan_address": {
      ...
      "MY": "14-12, Achasan-ro 62-gil, Gwangjin-gu, Seoul (Daeyeong Twin, Guui-dong)"
    },
    "republic_of_korea": {
      "KR": "대한민국",
      "VN": "Hàn Quốc",
    ...
    "no_reservations_in_progress": {
      ...
      "MY": "No reservations in progress"
    },
    "total_completed_reservations": {
      ...
      "MY": "Total Completed Reservations"
    },
    // PointSection 관련
    "my_points": {
      "KR": "내 적립금",
    ...
    "recommendation_activated": {
      ...
      "MY": "Recommended friends activated!"
    },
    "error_occurred": {
      "KR": "오류가 발생했습니다",
      "VN": "Đã xảy ra lỗi",
    ...
    "minimum_withdrawal": {
      ...
      "MY": "Withdrawal from RM 100,000 and above."
    },
  };
}